...
-- 3. Herkese okuma + yazma izni (anon key ile admin paneli çalışsın)
DROP POLICY IF EXISTS "allow_all" ON site_content;
CREATE POLICY "allow_all" ON site_content
...
('hero', $json$[
  {
    ...
    "headline": "Yeni Sezon\nÇekirdekleri Geldi",
    "sub": "Etiyopya, Kolombiya ve Guatemala'dan taze kavrulmuş tek kökenli kahveler.",
    "cta": "Hemen Keşfet",
    "href": "/magazin"
  },
  {
    "id": "slide-2",
    "image": "https://images.unsplash.com/photo-1511920170033-f8396924c348?w=1800&q=90",
    "position": "center center",
    "headline": "Abonelik ile\n%15 İndirim",
    "sub": "İki haftada bir taze kavrum. Siparişten sonra 48 saatte kapında.",
    "cta": "Aboneliği Başlat",
    "href": "/abonelik"
  },
  {
    "id": "slide-3",
    "image": "/uploads/dearko-arac.png",
    "position": "center center",
    "headline": "Mobil Kahve\nAracını Kirala",
    "sub": "Festival, düğün, kurumsal etkinlik. Profesyonel barista ve ekipman dahil.",
    "cta": "Rezervasyon Yap",
    "href": "/rezervasyon"
  },
  {
    "id": "slide-4",
    "image": "https://images.unsplash.com/photo-1497935586047-9395ee010a64?w=1800&q=90",
    "headline": "Kurumsal\nKahve Çözümleri",
    "sub": "Ofisine özel abonelik planları ve ekipman desteği.",
    "cta": "Planları Gör",
    "href": "/kurumsal"
  }
]$json$),
...
-- 5. Kontrol
SELECT id, updated_at FROM site_content ORDER BY id;
